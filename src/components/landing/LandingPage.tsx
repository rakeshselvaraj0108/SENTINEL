    ...
    <main className="relative h-dvh w-full overflow-hidden bg-bg text-text">
      ...
      <section className="pointer-events-none relative z-10 flex h-full max-w-[46rem] flex-col justify-center px-5 sm:px-10 lg:px-16">
        ...
        >
          <button
            type="button"
            onClick={start}
            className="group flex items-center gap-2 border px-5 py-2.5 font-data text-[11px] uppercase tracking-[0.14em] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-bg"
      ...
      {flying && (
        <button
          type="button"
          onClick={go}
          className="absolute bottom-16 right-6 z-50 border border-border-soft px-3 py-1.5 font-data text-[10px] uppercase tracking-[0.14em] text-text-muted hover:text-text"
        >
          skip
        </button>
      )}
