...
import { graphNodes, graphEdges, activeEdgeIds, finding } from "@/lib/mock-data";
import type { AgentId, GraphNode } from "@/lib/types";
...
const severityColor: Record<typeof finding.severity, string> = {
...
export function AgentNetworkPanel({ selectedAgentId, onSelectAgent }: AgentNetworkPanelProps) {
